...
<article id="post-<?php the_ID(); ?>" <?php post_class( $custom_class ); ?> <?php esc_attr( blogmatic_set_aos_animation_data_attribute() ); ?>>
    <div class="blogmatic-article-inner">
        ...
        <figure class="post-thumbnail-wrapper">
            <div class="post-thumnail-inner-wrapper swiper">
                <?php
                    ...
                    if( $gallery_content ) {
                        if( isset( $gallery_content['ids'] ) ) :
                            ...
                            echo '<div class="thumbnail-gallery-slider swiper-wrapper">';
                                foreach( $source as $image ) {
                                    echo '<img class="swiper-slide" src="' .wp_get_attachment_image_url($image,$archive_image_size). '" loading="lazy"/>';
                                }
                            echo '</div>';
                            echo '<div class="custom-button-prev swiper-arrow"><i class="fa-solid fa-arrow-left-long"></i></div>';
                            echo '<div class="custom-button-next swiper-arrow"><i class="fa-solid fa-arrow-right-long"></i></div>';
                        endif;
                    } else {

 ...
 */
 ...
 class Blogmatic_Category_Collection_Widget extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'blogmatic_category_collection_widget',
            esc_html__( 'Blogmatic: Category Collection', 'blogmatic-pro' ),
            [ 'description' => __( 'A collection of post categories', 'blogmatic-pro' ) ]
        );
    }
                ...
                <div class="categories-wrap">
                    <?php
                        ...
                        foreach( $post_categories as $cat ) :
                            ...
                            $widget_post = new WP_Query( apply_filters( 'blogmatic_query_args_filter', $post_args ) );
                            $thumbnail_url = '';
                            ...
                            wp_reset_postdata();
                            ?>
                                <div class="post-thumb category-item cat-<?php echo esc_attr( $cat_id ); ?>" <?php esc_attr( blogmatic_set_aos_animation_data_attribute() ); ?>>
    ...
    public function widget_fields() {
        ...
        return [
            [
                ...
                'default'   =>  esc_html__( 'Category Collection', 'blogmatic-pro' )
            ],
            [
                'name'  =>  'post_categories',
                'type'  =>  'select-two',
                'title' =>  esc_html__( 'Post Categories', 'blogmatic-pro' ),
                'description'   =>  esc_html__( 'Choose the caategories to display', 'blogmatic-pro' ),

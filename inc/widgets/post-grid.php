 ...
 */
 ...
 class Blogmatic_Post_Grid_Widget extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'blogmatic_post_grid_widget',
            esc_html__( 'Blogmatic: Post Grid', 'blogmatic-pro' ),
            [ 'description' => __( 'A collection of post in a grid', 'blogmatic-pro' ) ]
        );
    }
            ...
            if( $post_grid_query->have_posts() ) :
                ...
                if( $ajax_load_more_option && $post_grid_query->max_num_pages > 1 ) :
                    ...
                    <div class="blogmatic-widget-loader">
                            <button class="load-more" data-widget="blogmatic_post_grid_widget" data-instance="<?php echo esc_attr( json_encode( $instance ) ); ?>"><?php echo esc_html__( 'Show more', 'blogmatic-pro' ); ?></button>
                        </div>
                    <?php
                endif;
            endif;
    ...
    public function widget_fields() {
        ...
        return [
            [
                ...
                'default'   =>  esc_html__( 'Post Grid', 'blogmatic-pro' )
            ],
            [
                'name'  =>  'post_catgories',
                'type'  =>  'select-two',
            ...
            [
                ...
                'title' =>  esc_html__( 'Image Ratio', 'blogmatic-pro' ),
                'min'   =>  0,
                'max'   =>  2,
                'step'  =>  0.1,
                'default'   =>  json_encode([

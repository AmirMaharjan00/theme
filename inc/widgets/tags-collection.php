 ...
 */
 ...
 class Blogmatic_Tags_Collection_Widget extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'blogmatic_tags_collection_widget',
            esc_html__( 'Blogmatic: Tags Collection', 'blogmatic-pro' ),
            [ 'description' => __( 'A collection of post tags', 'blogmatic-pro' ) ]
        );
    }
                ...
                <div class="tags-wrap">
                    <?php
                        ...
                        foreach( $post_tags as $tag ) :
                            ...
                            $tag_id = $tag->term_id;
                            ?>
                                <div class="post-thumb tags-item tag-<?php echo esc_attr( $tag_id ); ?>" <?php esc_attr( blogmatic_set_aos_animation_data_attribute() ); ?>>
    ...
    public function widget_fields() {
        ...
        return [
            [
                ...
                'default'   =>  esc_html__( 'Tags Collection', 'blogmatic-pro' )
            ],
            [
                'name'  =>  'post_tags',
                'type'  =>  'select-two',
                'title' =>  esc_html__( 'Post tags', 'blogmatic-pro' ),
                'description'   =>  esc_html__( 'Choose the tags to display', 'blogmatic-pro' ),

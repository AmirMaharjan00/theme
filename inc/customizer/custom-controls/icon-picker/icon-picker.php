...
if( class_exists( 'WP_Customize_Control' ) ) :
    class Blogmatic_WP_Icon_Picker_Control extends \WP_Customize_Control {
        /**
         * Control type
         * 
         */
        ...
        public function enqueue() {
            wp_enqueue_style( 'blogmatic-customizer-icon-picker', get_template_directory_uri() . '/inc/customizer/custom-controls/icon-picker/control.css', array(), BLOGMATIC_VERSION, 'all' );
            wp_enqueue_media();
            wp_enqueue_script( 'blogmatic-customizer-icon-picker', get_template_directory_uri() . '/inc/customizer/custom-controls/icon-picker/control.js', array('jquery'), BLOGMATIC_VERSION, true );
        }
    ...
    ?>
            <div class="customize-icon-picker">
                ...
                <span class="picker-buttons-wrap">
                    <span class="button-action select-none <?php if( $value['type'] == 'none' ) echo 'active' ?>" title="<?php echo esc_attr( 'None' ); ?>"><i class="fa-solid fa-ban"></i></span>
                    <?php if( $this->include_media ) : ?>
                ...
                <?php 
                    ...
                    $icons_array = blogmatic_get_all_fontawesome_icons();
                    if( $icons_array ) :
                        echo '<div class="icon-picker-modal" style="display:none">';
                            echo '<div class="icon-picker-search">';
                                echo '<input type="search" placeholder="' .esc_html__( 'Type to search . .', 'blogmatic-pro' ). '"/>';
                            echo '</div>';

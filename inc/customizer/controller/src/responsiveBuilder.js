...
import { BlogmaticControlHeader, convertNumbertoOrdinalString, blogmaticReflectResponsiveInControl, blogmaticBackButtonClick } from './component-function'
...
export const BlogmaticResponsiveBuilder = ( props ) => {
    const [ value, setValue ] = useState( props.value )
    const { label, description, widgets, responsive_canvas_id: canvasId, placement, builder_settings_section: builderSettingsSection, responsive_section: responsiveSection } = customize.settings.controls[props.setting]
    ...
    const { setResponsiveHeaderBuilderReflector } = useDispatch( myCustomStore );

...
if( ! class_exists( 'Admin_Page' ) ) :
    ...
    class Admin_Page {
        ...
        public function __construct() {
            ...
            add_action( 'admin_menu', [ $this, 'blogmatic_info_page' ], 10 );
            add_action( 'admin_enqueue_scripts', [ $this, 'admin_scripts' ] );
            add_action( 'wp_ajax_blogmatic_importer_plugin_action', array( $this, 'blogmatic_importer_plugin_action' ) );
            new Admin_Notices();
        }
        ...
        public function admin_scripts( $hook ) {
            if( $hook == 'toplevel_page_blogmatic-info' ) {
                wp_enqueue_style( 'blogmatic-info', get_template_directory_uri() . '/inc/admin/assets/admin-page.css', [], BLOGMATIC_VERSION, 'all' );
                wp_enqueue_script( 'blogmatic-info', get_template_directory_uri() . '/inc/admin/assets/admin-page.js', [], BLOGMATIC_VERSION, true );
            }
            wp_enqueue_script( 'blogmatic-notice', get_template_directory_uri() . '/inc/admin/assets/admin-notice.js', [], BLOGMATIC_VERSION, true );
            wp_enqueue_style( 'blogmatic-info-notice', get_template_directory_uri() . '/inc/admin/assets/admin-notice.css', [], BLOGMATIC_VERSION, 'all' );
            wp_localize_script( 'blogmatic-info', 'blogmaticThemeInfoObject', array(
                'ajaxUrl'   => admin_url( 'admin-ajax.php' ),
                '_wpnonce'  => wp_create_nonce( 'blogmatic-theme-info-nonce' )
            ));
            wp_localize_script( 'blogmatic-notice', 'blogmaticNoticeOject', array(
                'ajaxUrl'   => admin_url( 'admin-ajax.php' ),
                '_wpnonce'  => wp_create_nonce( 'blogmatic-notice-nonce' ),
                'welcomeOption' =>  'blogmatic_welcome_notice_dismiss'
            ));
        }
    
        /**
         * Function to Blogmatic Info admin menu page
         * 
         * @since 1.0.0
         */
        public function blogmatic_info_page() {
            add_menu_page( 
                esc_html__( 'Blogmatic Info', 'blogmatic-pro' ),
                esc_html__( 'Blogmatic Info', 'blogmatic-pro' ),
                'manage_options',
                'blogmatic-info',
                [ $this, 'blogmatic_info_callback' ],
                '',
                59
            );
        }
        ...
        /**
         * Callback function when registering Blogmatic Info admin menu page
         * 
         * @since 1.0.0
         */
        public function blogmatic_info_callback() {
            $starter_sites_class = 'starter-sites-section-wrap';
            if( array_key_exists( 'blogmatic_importer_activated', $_POST ) ) :
                $nonce = $_POST['blogmatic_importer_activated'];
                if ( wp_verify_nonce( $nonce, 'blogmatic_form_action' ) ) $starter_sites_class .= ' active';
            endif;
            ?>
                <div class="blogmatic-info-page" id="blogmatic-info-page">
                    <div class="blogmatic-info-page-inner box-container">
            ...
            ?>
                <div class="internal-links-section admin--card">
                    <div class="card-header">
                        ...
                        <div class="card-description"><?php echo esc_html__( 'Theme provides handy customizer that allows you to modify the site looks. You can click on the below links to navigate to the particular sections.', 'blogmatic-pro' ); ?></div>
                    </div>
                    <ul class="internal-links-section-list">
                        <li class="list-item">
                            <span class="dashicons dashicons-admin-customizer"></span>
                            <a href="<?php echo admin_url( 'customize.php' ); ?>" target="_blank"><?php echo esc_html__( 'Customize Site', 'blogmatic-pro' ); ?></a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-heading"></span>
                            <a href="<?php echo admin_url( 'customize.php?autofocus[section]=header_builder_section_settings' ); ?>" target="_blank">
                                <?php echo esc_html__( 'Edit Header', 'blogmatic-pro' ); ?>
                            </a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-edit"></span>
                            <a href="<?php echo admin_url( 'customize.php?autofocus[control]=single_post_layout' ); ?>" target="_blank">
                                <?php echo esc_html__( 'Edit Single Post', 'blogmatic-pro' ); ?>
                            </a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-edit"></span>
                            <a href="<?php echo admin_url( 'customize.php?autofocus[control]=page_settings_sidebar_layout' ); ?>" target="_blank">
                                <?php echo esc_html__( 'Edit Single Page', 'blogmatic-pro' ); ?>
                            </a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-editor-ul"></span>
                            <a href="<?php echo admin_url( 'customize.php?autofocus[control]=archive_post_column' ); ?>" target="_blank">
                                <?php echo esc_html__( 'Edit Archive', 'blogmatic-pro' ); ?>
                            </a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-hammer"></span>
                            <a href="<?php echo admin_url( 'customize.php?autofocus[control]=footer_builder_section_settings' ); ?>" target="_blank">
                                <?php echo esc_html__( 'Edit Footer', 'blogmatic-pro' ); ?>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        public function external_links_section() {
            ?>
                <div class="external-links-section admin--card">
                    <div class="card-header">
                        <h2 class="card-title"><?php echo esc_html__( 'Several outside resources to help you fully understand the theme.', 'blogmatic-pro' ); ?></h2>
                        <div class="card-description"><?php echo esc_html__( 'We offer blogs, demos, documentation, and support forums for quick assistance. We hope this makes it easier for you.', 'blogmatic-pro' ); ?></div>
                    </div>
                    <ul class="external-links-section-list">
                        <li class="list-item">
                            <span class="dashicons dashicons-star-filled"></span>
                            <a href="<?php echo esc_url( '//wordpress.org/support/theme/blogmatic/reviews/?filter=5' ); ?>" target="_blank"><?php echo esc_html__( 'Leave a review', 'blogmatic-pro' ); ?></a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-media-document"></span>
                            <a href="<?php echo esc_url( '//doc.blazethemes.com/blogmatic/' ); ?>" target="_blank"><?php echo esc_html__( 'Documentation', 'blogmatic-pro' ); ?></a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-visibility"></span>
                            <a href="<?php echo esc_url( '//preview.blazethemes.com/blogmatic-one/' ); ?>" target="_blank"><?php echo esc_html__( 'View demo', 'blogmatic-pro' ); ?></a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-admin-site"></span>
                            <a href="<?php echo esc_url( '//www.blazethemes.com' ); ?>" target="_blank"><?php echo esc_html__( 'Official site', 'blogmatic-pro' ); ?></a>
                        </li>
                        <li class="list-item">
                            <span class="dashicons dashicons-welcome-write-blog"></span>
                            <a href="<?php echo esc_url( '//blazethemes.com/blog/ ' ); ?>" target="_blank"><?php echo esc_html__( 'Blog', 'blogmatic-pro' ); ?></a>
                        </li>
                    </ul>
                </div>
            <?php
        ...
        public function recommended_section() {
            ?>
                <div class="recommended-section admin--card">
                    <div class="card-header">
                        <h2 class="card-title"><?php echo esc_html__( 'Recommended Plugins', 'blogmatic-pro' ); ?></h2>
                        <div class="card-description"><?php echo esc_html__( 'We recommend different useful plugins that can boost functionality, security, and user experience on your site.', 'blogmatic-pro' ); ?></div>
                    </div>
                                        ...
                                        <li class="list-item">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <span class="item-version">
                                                    <?php
                                                        echo esc_html__( 'Version: ', 'blogmatic-pro' );
                                                ...
                                                <div class="external-links">
                                                    <a class="view-on-org external-link" href="<?php echo esc_url( '//wordpress.org/plugins/' . $plugin['slug'] ); ?>" target="_blank"><?php echo esc_html__( 'View on Wordpress.org', 'blogmatic-pro' ); ?></a>
                                                    <?php
                                                        ...
                                                        if( $plugin['homepage'] ) echo '<a class="official-site external-link" href="'. esc_url( $plugin['homepage'] ) .'" target="_blank">'. esc_html__( 'Official site', 'blogmatic-pro' ) .'</a>';
                                                    ?>
                                                </div>
                                            </div>
                                        </li>
            ...
            ?>
                <div class="starter-sites-section off-canvas">
                    <div class="canvas-header">
                        <h2 class="canvas-title"><?php echo esc_html__( 'All starter sites', 'blogmatic-pro' ); ?></h2>
                        <div class="canvas-description"><?php echo esc_html__( 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'blogmatic-pro' ); ?></div>
                    </div>
                            ...
                            <span class="status-message">
                                <?php
                                    if( in_array( $status, [ 'not-installed', 'inactive' ] ) ) :
                                        ...
                                        $prefix = ( $status == 'not-installed' ) ? esc_html__( ' to install and activate one click demo importer plugin', 'blogmatic-pro' ) : esc_html__( ' to activate one click demo importer plugin', 'blogmatic-pro' ) ;
                                        echo esc_html__( 'Click', 'blogmatic-pro' );
                                        $importer_args = [
                                        ...
                                        echo esc_html__( 'You are all set to install the demo.', 'blogmatic-pro' );
                                    endif;
                                ?>
                            </span>
                            <form action="<?php echo esc_html( $_SERVER['REQUEST_URI'] ); ?>" method="post" id="blogmatic-form">
                                <?php
                                    $nonce = wp_create_nonce( 'blogmatic_form_action' );
                                    wp_nonce_field( 'blogmatic_form_action', 'blogmatic_importer_activated' ); 
                    ...
                    <div class="canvas-expand">
                        ...
                        <span class="button-label"><?php echo esc_html__( 'View all', 'blogmatic-pro' ); ?></span>
                    </div>
                </div>
            <?php
        }
            ...
            if( ! in_array( $status, [ 'not-installed', 'inactive' ] ) ) :
                ?>
                    <div class="demo-buttons">
                        <a href="<?php echo esc_url( $preview_url ); ?>" target="_blank" class="demo-preview demo-button"><?php echo esc_html__( 'Preview', 'blogmatic-pro' ); ?></a>
                        <?php
                            if( $this->is_premium || $type == 'free' ): 
                                ?>
                                    <a href="#blaze-demo-importer-modal-<?php echo esc_attr( $slug ) ?>" class="blaze-demo-importer-modal-button">
                                        <?php echo esc_html__( 'Install', 'blogmatic-pro' ); ?>
                                    </a>
                                <?php
                            else: 
                                ?>
                                    <a href="<?php ?>" class="purchase-pro">
                                        <?php echo esc_html__( 'Buy Pro', 'blogmatic-pro' ); ?>
                                    </a>
                                <?php
                            endif;
                        ?>
        ...
        public function get_filter_tabs(){
            $list_items = [
                'all'  =>  esc_html__( 'All', 'blogmatic-pro' )
            ];
            if( ! empty( $this->demos ) && is_array( $this->demos ) ) :
                // for type
                if( ! $this->is_premium ) :
        ...
        public function get_demo_label( $type ) {
            ...
            switch( $type ) :
                case 'free':
                    return esc_html__( 'Free', 'blogmatic-pro' );
                    break;
                case 'pro':
                    return esc_html__( 'Pro', 'blogmatic-pro' );
                    break;
                default:
                    return esc_html__( 'Default', 'blogmatic-pro' );
                    break;
            endswitch;
        }
        ...
        public function plugin_status_button( $status, $importer = false, $args = [] ) {
            ...
            switch( $status ) :
                case 'not-installed' :
                    $label = $importer ? esc_html__( 'Here', 'blogmatic-pro' ) : esc_html__( 'Install and Activate', 'blogmatic-pro' );
                    $class .= ' action-trigger not-installed';
                    break;
                case 'active' :
                    $class .= ' active';
                    $property = ' disabled';
                    $label = esc_html__( 'Installed & Activated', 'blogmatic-pro' );
                    if( $importer ) :
                        $property = '';
                        $class .= ' importer';
                        $label = esc_html__( 'Import', 'blogmatic-pro' );
                    endif;
                    break;
                case 'inactive' :
                    $label = $importer ? esc_html__( 'activate', 'blogmatic-pro' ) : esc_html__( 'Activate', 'blogmatic-pro' );
                    $class .= ' inactive';
         ...
         * @since 1.0.0
         */
        public function blogmatic_importer_plugin_action() {
            $this->plugin_active_install_action( 'blogmatic-theme-info-nonce' );
        }
        ...
        public function plugin_active_install_action( $nonce = '' ) {
            ...
            if( $_plugin_action === 'inactive' ) {
                ...
                $this->ajax_response['message'] = ( $importer_or_not == 'true' ) ? esc_html__( 'Plugin activated', 'blogmatic-pro' ) : esc_html__( 'Demo importer plugin activated', 'blogmatic-pro' );
            ...
            $this->ajax_response['message'] = esc_html__( 'Error while trying to install or active the plugin.', 'blogmatic-pro' );
            $this->send_ajax_response();
        }
            ...
            ?>
                <div class="wrap blaze-demo-importer-demo-importer-wrap">
                                ...
                                ?>
                                    <div id="blaze-demo-importer-modal-<?php echo esc_attr( $demo_slug ) ?>" class="blaze-demo-importer-modal" style="display: none;">
                                        ...
                                        <div class="blaze-demo-importer-modal-header">
                                            <h2><?php printf( esc_html( 'Import %s Demo', 'blogmatic-pro' ), esc_html( $demo_pack['name'] ) ); ?></h2>
                                        ...
                                        <div class="blaze-demo-importer-modal-wrap">
                                            <p><?php echo sprintf( esc_html__('We recommend you backup your website content before attempting to import the demo so that you can recover your website if something goes wrong. You can use %s plugin for it.', 'blogmatic-pro' ), '<a href="https://wordpress.org/plugins/all-in-one-wp-migration/" target="_blank">' . esc_html__( 'All in one migration', 'blogmatic-pro' ) . '</a>' ); ?></p>

                                            <p><?php echo esc_html__( 'This process will install all the required plugins, import contents and setup customizer and theme options.', 'blogmatic-pro' ); ?></p>

                                            <div class="blaze-demo-importer-modal-recommended-plugins">
                                                <h4><?php esc_html_e( 'Required Plugins', 'blogmatic-pro' ); ?></h4>
                                                <p><?php esc_html_e( 'For your website to look exactly like the demo,the import process will install and activate the following plugin if they are not installed or activated.', 'blogmatic-pro' ); ?></p>
                                                <?php
                                                ...
                                                if ( is_array( $plugins ) ) :
                                                    ...
                                                    ?>
                                                        <ul>
                                                            <li><?php esc_html_e( 'No Required Plugins Found.', 'blogmatic-pro' ); ?></li>
                                                        </ul>
                                                    <?php
                                                endif;
                                                ?>
                                            ...
                                            <ul class="blaze-demo-importer-reset-checkbox">
                                                <h4><?php esc_html_e( 'Files', 'blogmatic-pro' ) ?></h4>
                                                <li>
                                                    <label class="blaze-demo-importer-files-checkbox">
                                                        ...
                                                        <?php echo esc_html( 'Customizer.dat', 'blogmatic-pro' ); ?>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="blaze-demo-importer-files-checkbox">
                                                        <input id="checkbox-widget-<?php echo esc_attr( $demo_slug ); ?>" type="checkbox" checked="checked" />
                                                        <?php echo esc_html( 'Widget.wie', 'blogmatic-pro' ); ?>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="blaze-demo-importer-files-checkbox">
                                                        <input id="checkbox-content-<?php echo esc_attr( $demo_slug ); ?>" type="checkbox" checked="checked" />
                                                        <?php echo esc_html( 'Content.xml.', 'blogmatic-pro' ); ?>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="blaze-demo-importer-files-checkbox">
                                                        <input id="checkbox-attachment-<?php echo esc_attr( $demo_slug ); ?>" type="checkbox" />
                                                        <?php echo esc_html( 'Attachments like images, audios, videos, etc.', 'blogmatic-pro' ); ?>
                                                    </label>
                                                </li>
                                            </ul>
                                            <a href="javascript:void(0)" class="button blaze-demo-importer-modal-cancel"><?php esc_html_e ( 'Cancel', 'blogmatic-pro' ); ?></a>
                                            <a href="javascript:void(0)" data-demo-slug="<?php echo esc_attr( $demo_slug ) ?>" class="button button-primary blaze-demo-importer-import-demo"><?php esc_html_e( 'Import Demo', 'blogmatic-pro' ); ?></a>
                                        </div>
                                    </div>
                                <?php
                            endforeach;
                    ...
                    <div id="blaze-demo-importer-import-progress" style="display: none">
                        <h2 class="blaze-demo-importer-import-progress-header"><?php echo esc_html__( 'Demo Import Progress', 'blogmatic-pro' ); ?></h2>
                        ...
                        <div class="blaze-demo-importer-import-progress-message"><div class="message-item"></div></div>
                            ...
                            <span class="progress-bar-note"><?php esc_html_e( 'Demo import success', 'blogmatic-pro' ); ?></span>
                        </div>
                        </div>
                </div>
            <?php
...
if( ! class_exists( 'Admin_Notices' ) ) :
    ...
    class Admin_Notices extends Admin_Page {
        ...
        public function __construct() { 
            $this->restriction_message = esc_html__( "You dont have permission to perform this action", 'blogmatic-pro' );
            ...
            add_action( 'wp_ajax_blogmatic_admin_notice_ajax_call', [ $this, 'admin_notice_ajax_call' ] );
            add_action( 'wp_ajax_blogmatic_importer_plugin_action_for_notice', [ $this, 'blogmatic_importer_plugin_action_for_notice' ] );
        }
        ...
        public function admin_welcome_notice() {
            ...
            if( isset( $_GET['page'] ) && in_array( $_GET['page'], [ 'blogmatic-info', 'blaze-system-info' ] ) ) return;

            if( get_option( 'blogmatic_welcome_notice_dismiss' ) ) return;

            $this->notice_wrapper_open('blogmatic-welcome-notice notice-info');
            ?>
                <div class="notice-content">
                    <div class="notice-header">
                        <h2 class="notice-title"><?php echo esc_html__( 'Thank you for activating Blogmatic Premium Version!!', 'blogmatic-pro' ); ?></h2>
                    </div>
                    <p class="notice-description"><?php echo esc_html__( 'Get started with multipurpose news theme and give your site a new look. We recommend you to please go through the documentation to get started with theme and setup homepage quicky.', 'blogmatic-pro' ); ?></p>
                    <div class="notice-actions">
                        <a class="action-button importer" href="<?php echo admin_url( 'admin.php?page=blogmatic-info' ); ?>"><?php echo esc_html__( 'Install Demos', 'blogmatic-pro' ); ?></a>
                        <a class="action-button" href="<?php echo admin_url( 'customize.php' ); ?>" target="_blank"><?php echo esc_html__( 'Customize Site', 'blogmatic-pro' ); ?></a>
                        <a class="action-button" href="<?php echo esc_url( '//doc.blazethemes.com/blogmatic/' ); ?>" target="_blank"><?php echo esc_html__( 'Documentation', 'blogmatic-pro' ); ?></a>
                    </div>
                </div>
                <?php $this->get_notice_preview(); ?>
                <button class="alert-dismiss"><?php echo esc_html__( 'Dismiss this notice', 'blogmatic-pro' ); ?></button>
            <?php
        ...
        public function notice_wrapper_open( $classes = '' ) {
            if( $classes != '' ) {
                echo '<div class="blogmatic-admin-notice notice is-dismissible ' .esc_attr( $classes ). '">';
            } else {
                echo '<div class="blogmatic-admin-notice notice is-dismissible">';
            }
        ...
        public function notice_wrapper_close() {
            ...
            echo '</div><!-- .blogmatic-admin-notice -->';
        }
        ...
        public function admin_notice_ajax_call() {
            check_ajax_referer( 'blogmatic-notice-nonce', '_wpnonce' );
            ...
            $this->ajax_response['status'] = true;
            $this->ajax_response['message'] = esc_html__( 'Welcome notice hidden', 'blogmatic-pro' );
            $this->send_ajax_response();
            wp_die();
        }
         ...
         * @since 1.0.0
         */
        public function blogmatic_importer_plugin_action_for_notice() {            
            $this->plugin_active_install_action( 'blogmatic-notice-nonce' );
        }
    }
endif;
<?php
/**
 * Blogmatic functions and definitions
 *
...
if ( ! defined( 'BLOGMATIC_VERSION' ) ) {
	// Replace the version number of the theme on each release.
	$theme_info = wp_get_theme();
	define( 'BLOGMATIC_VERSION', $theme_info->get( 'Version' ) );
}

if ( ! defined( 'BLOGMATIC_PREFIX' ) ) {
	// Replace the prefix of theme if changed.
	define( 'BLOGMATIC_PREFIX', 'blogmatic_' );
}
 ...
 */
function blogmatic_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Blogmatic, use a find and replace
		* to change 'blogmatic-pro' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'blogmatic-pro', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'blogmatic-pro' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'blogmatic_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'blogmatic_setup' );
 ...
 */
function blogmatic_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'blogmatic_content_width', 640 );
}
add_action( 'after_setup_theme', 'blogmatic_content_width', 0 );

/**
 * Enqueue scripts and styles.
 */
function blogmatic_scripts() {
	require_once get_theme_file_path( 'inc/wptt-webfont-loader.php' );
	wp_enqueue_style( 'blogmatic-typo-fonts', wptt_get_webfont_url( esc_url_raw( blogmatic_typo_fonts_url() ) ), array(), null );
	wp_enqueue_style( 'blogmatic-style', get_stylesheet_uri(), array(), BLOGMATIC_VERSION );
	wp_add_inline_style( 'blogmatic-style', blogmatic_current_styles() );
	// wp_add_inline_style( 'blogmatic-style', blogmatic_custom_styles() );
	wp_enqueue_style( 'blogmatic-main', get_template_directory_uri() . '/assets/css/main.css', [], BLOGMATIC_VERSION, 'all' );
	wp_enqueue_style( 'blogmatic-builder', get_template_directory_uri() . '/assets/css/builder.css', [], BLOGMATIC_VERSION, 'all' );
	wp_enqueue_style( 'blogmatic-aimation', get_template_directory_uri() . '/assets/css/animation.css', [], BLOGMATIC_VERSION, 'all' );
	wp_enqueue_style( 'blogmatic-preloader', get_template_directory_uri() . '/assets/css/preloader.css', [], BLOGMATIC_VERSION, 'all' );
	wp_enqueue_style( 'blogmatic-additional', get_template_directory_uri() . '/assets/css/additional.css', [], BLOGMATIC_VERSION, 'all' );
	wp_enqueue_style( 'blogmatic-responsive', get_template_directory_uri() . '/assets/css/responsive.css', [], BLOGMATIC_VERSION, 'all' );
	wp_enqueue_style( 'swiper', get_template_directory_uri() .'/assets/external/swiper/swiper-bundle.min.css', [], '11.1.8', 'all' );
	...
	wp_enqueue_style( 'aos', get_template_directory_uri() .'/assets/external/aos/aos.css', [], BLOGMATIC_VERSION, 'all' );
	wp_style_add_data( 'blogmatic-style', 'rtl', 'replace' );

	wp_enqueue_script( 'swiper', get_template_directory_uri() . '/assets/external/swiper/swiper-bundle.min.js', array(), '11.1.8', true );
	wp_enqueue_script( 'blogmatic-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), BLOGMATIC_VERSION, true );
	wp_enqueue_script( 'blogmatic-js', get_template_directory_uri() . '/assets/js/theme.js', ['jquery','jquery-masonry'], BLOGMATIC_VERSION, true );
	wp_enqueue_script( 'jquery-cookie', get_template_directory_uri() . '/assets/external/jquery-cookie/jquery-cookie.js', [], BLOGMATIC_VERSION, true );
	wp_enqueue_script( 'magnific-popup', get_template_directory_uri() . '/assets/external/magnific-popup/magnific-popup.js', [], BLOGMATIC_VERSION, true );
	wp_enqueue_script( 'aos', get_template_directory_uri() . '/assets/external/aos/aos.js', [], BLOGMATIC_VERSION, true );

	wp_localize_script( 'blogmatic-js', 'blogmaticObject', [
		'ajaxUrl'   => admin_url( 'admin-ajax.php' ),
		'_wpnonce'  => wp_create_nonce( 'blogmatic-security-nonce' ),
		'themeColor'	=>	BMC\blogmatic_get_customizer_option( 'theme_color' ),
		'isArchive'	=> ( is_archive() || is_home() || ( BMC\blogmatic_get_customizer_option( 'archive_post_layout' ) == 'masonry' ) ),
		'arrows'	=> json_encode( BMC\blogmatic_get_customizer_option( 'main_banner_show_arrows' ) ),
		'fade'	=> json_encode( BMC\blogmatic_get_customizer_option( 'main_banner_show_fade' ) ),
		'infiniteLoop'	=> json_encode( BMC\blogmatic_get_customizer_option( 'main_banner_slider_infinite_loop' ) ),
		'autoplay'	=> json_encode( BMC\blogmatic_get_customizer_option( 'main_banner_slider_autoplay' ) ),
		'autoplaySpeed'	=> json_encode( BMC\blogmatic_get_customizer_option( 'main_banner_slider_autoplay_speed' ) ),
		'speed'	=> json_encode( BMC\blogmatic_get_customizer_option( 'main_banner_slider_speed' ) ),
		'showArrowOnHover'	=> json_encode( BMC\blogmatic_get_customizer_option( 'main_banner_show_arrow_on_hover' ) ),
		'prevIcon'	=> json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'main_banner_slider_prev_arrow' ) ) ),
		'nextIcon'	=> json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'main_banner_slider_next_arrow' ) ) ),
		'carouselArrows'	=> json_encode( BMC\blogmatic_get_customizer_option( 'carousel_show_arrows' ) ),		
		'carouselInfiniteLoop'	=> json_encode( BMC\blogmatic_get_customizer_option( 'carousel_slider_infinite_loop' ) ),
		'carouselAutoplay'	=> json_encode( BMC\blogmatic_get_customizer_option( 'carousel_slider_autoplay' ) ),
		'carouselAutoplaySpeed'	=> json_encode( BMC\blogmatic_get_customizer_option( 'carousel_slider_autoplay_speed' ) ),
		'carouselSpeed'	=> json_encode( BMC\blogmatic_get_customizer_option( 'carousel_slider_speed' ) ),
		'carouselShowArrowOnHover'	=> json_encode( BMC\blogmatic_get_customizer_option( 'carousel_show_arrow_on_hover' ) ),	
		'carouselSlideToShow'	=> json_encode( BMC\blogmatic_get_customizer_option( 'carousel_no_of_columns' ) ),
		'slidesToScroll'	=> json_encode( BMC\blogmatic_get_customizer_option( 'carousel_slides_to_scroll' ) ),
		'carouselPrevIcon'	=> json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'carousel_slider_prev_arrow' ) ) ),
		'carouselNextIcon'	=> json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'carousel_slider_next_arrow' ) ) ),

		'themeModeLightIcon'	=>	BMC\blogmatic_get_customizer_option( 'theme_mode_light_icon' ),
		'themeModeDarkIcon'	=>	BMC\blogmatic_get_customizer_option( 'theme_mode_dark_icon' ),
		'singleGalleryLightbox'	=>	BMC\blogmatic_get_customizer_option( 'single_gallery_lightbox_option' ),
		'headerSticky'	=>	BMC\blogmatic_get_customizer_option( 'header_buiilder_header_sticky' ),
		'liveSearchNoOfPostToDisplay'	=>	BMC\blogmatic_get_customizer_option( 'search_no_of_post_to_display' ),
		'liveSearchNoResultsFound'	=>	BMC\blogmatic_get_customizer_option( 'search_no_result_found_text' ),
		'liveSearchShowPostImage'	=>	BMC\blogmatic_get_customizer_option( 'search_post_image_show_hide' ),
		'liveSearchShowPostDate'	=>	BMC\blogmatic_get_customizer_option( 'search_post_date_show_hide' ),
		'liveSearchViewAllButtonText'	=>	BMC\blogmatic_get_customizer_option( 'search_view_all_button_text' ),
		'paginationNoResultsText'	=>	BMC\blogmatic_get_customizer_option( 'pagination_no_more_reults_text' ),
		'videoPlaylistPlayIcon'	=>	json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'video_playlist_play_icon' ) ) ),
		'videoPlaylistPauseIcon'	=>	json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'video_playlist_pause_icon' ) ) ),
		'videoPlaylistSliderarrow'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'video_playlist_slider_arrow' ) ),
		'videoPlaylistSliderShowArrowOnHover'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'video_playlist_slider_show_arrow_on_hover' ) ),
		'videoPlaylistSliderPrevIcon'	=>	json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'video_playlist_previous_icon' ) ) ),
		'videoPlaylistSliderNextIcon'	=>	json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'video_playlist_next_icon' ) ) ),
		'videoPlaylistSliderInfiniteLoop'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'video_playlist_slider_infinite' ) ),
		'videoPlaylistSliderSlidesToShow'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'video_playlist_slider_slides_to_show' ) ),
		'videoPlaylistSliderAutoplay'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'video_playlist_slider_autoplay' ) ),
		'breadcrumbSeparatorIcon'	=>	blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'breadcrumb_separator_icon' ) ),
		'preloaderDisplayCondition'	=>	BMC\blogmatic_get_customizer_option( 'display_preloader_animation' ),

		// instagram slider options
		'instagramSliderArrow'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'instagram_slider_arrow' ) ),
		'instagramPrevArrow'	=>	json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'instagram_prev_arrow' ) ) ),
		'instagramNextArrow'	=>	json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'instagram_next_arrow' ) ) ),
		'instagramAutoplayOption'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'instagram_autoplay_option' ) ),
		'instagramAutoplaySpeed'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'instagram_autoplay_speed' ) ),
		'instagramSliderInfinite'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'instagram_slider_infinite' ) ),
		'instagramSliderSpeed'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'instagram_slider_speed' ) ),
		'instagramSlidesToShow'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'instagram_slides_to_show' ) ),
		'instagramNumberOfColumns'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'instagram_no_of_columns' ) ),
		'instagramSlidesToScroll'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'instagram_slides_to_scroll' ) ),
		// instagram slider options
		'footerInstagramSliderArrow'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'footer_instagram_slider_arrow' ) ),
		'footerInstagramPrevArrow'	=>	json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'footer_instagram_prev_arrow' ) ) ),
		'footerInstagramNextArrow'	=>	json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'footer_instagram_next_arrow' ) ) ),
		'footerInstagramAutoplayOption'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'footer_instagram_autoplay_option' ) ),
		'footerInstagramAutoplaySpeed'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'footer_instagram_autoplay_speed' ) ),
		'footerInstagramSliderInfinite'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'footer_instagram_slider_infinite' ) ),
		'footerInstagramSliderSpeed'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'footer_instagram_slider_speed' ) ),
		'footerInstagramSlidesToShow'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'footer_instagram_slides_to_show' ) ),
		'footerInstagramNumberOfColumns'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'footer_instagram_no_of_columns' ) ),
		'footerInstagramSlidesToScroll'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'footer_instagram_slides_to_scroll' ) ),

		// category collection
		'catCollSliderArrow'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'category_collection_slider_arrow' ) ),
		'catCollPrevArrow'	=>	json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'category_collection_prev_arrow' ) ) ),
		'catCollNextArrow'	=>	json_encode( blogmatic_parse_icon_picker_value( BMC\blogmatic_get_customizer_option( 'category_collection_next_arrow' ) ) ),
		'catCollAutoplayOption'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'category_collection_autoplay_option' ) ),
		'catCollAutoplaySpeed'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'category_collection_autoplay_speed' ) ),
		'catCollSliderInfinite'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'category_collection_slider_infinite' ) ),
		'catCollSliderSpeed'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'category_collection_slider_speed' ) ),
		'catCollNumberOfColumns'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'category_collection_number_of_columns' ) ),
		'catCollSlidesToShow'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'category_collection_slides_to_show' ) ),
		'catCollSlidesToScroll'	=>	json_encode( BMC\blogmatic_get_customizer_option( 'category_collection_slides_to_scroll' ) ),
		
		// single table of content
		'tocOption'	=>	BMC\blogmatic_get_customizer_option( 'toc_option' ),
		'tocHeadingOption'	=>	BMC\blogmatic_get_customizer_option( 'toc_heading_option' ),
		'tocFieldForHeading'	=>	BMC\blogmatic_get_customizer_option( 'toc_field_for_heading' ),
		'tocHierarchical'	=>	BMC\blogmatic_get_customizer_option( 'toc_hierarchical' ),
		'tocListType'	=>	BMC\blogmatic_get_customizer_option( 'toc_list_type' ),
		'tocListIcon'	=>	BMC\blogmatic_get_customizer_option( 'toc_list_icon' ),
		'tocDisplayType'	=>	BMC\blogmatic_get_customizer_option( 'toc_display_type' ),
		'tocEnableAccordion'	=>	BMC\blogmatic_get_customizer_option( 'toc_enable_accordion' ),
		'tocDefaultToggle'	=>	BMC\blogmatic_get_customizer_option( 'toc_default_toggle' ),
		'tocOpenIcon'	=>	BMC\blogmatic_get_customizer_option( 'toc_open_icon' ),
		'tocCloseIcon'	=>	BMC\blogmatic_get_customizer_option( 'toc_close_icon' ),
		
		// page table of content
		'pageTocOption'	=>	BMC\blogmatic_get_customizer_option( 'page_toc_option' ),
		'pageTocHeadingOption'	=>	BMC\blogmatic_get_customizer_option( 'page_toc_heading_option' ),
		'pageTocFieldForHeading'	=>	BMC\blogmatic_get_customizer_option( 'page_toc_field_for_heading' ),
		'pageTocHierarchical'	=>	BMC\blogmatic_get_customizer_option( 'page_toc_hierarchical' ),
		'pageTocListType'	=>	BMC\blogmatic_get_customizer_option( 'page_toc_list_type' ),
		'pageTocListIcon'	=>	BMC\blogmatic_get_customizer_option( 'page_toc_list_icon' ),
		'pageTocDisplayType'	=>	BMC\blogmatic_get_customizer_option( 'page_toc_display_type' ),
		'pageTocEnableAccordion'	=>	BMC\blogmatic_get_customizer_option( 'page_toc_enable_accordion' ),
		'pageTocDefaultToggle'	=>	BMC\blogmatic_get_customizer_option( 'page_toc_default_toggle' ),
		'pageTocOpenIcon'	=>	BMC\blogmatic_get_customizer_option( 'page_toc_open_icon' ),
		'pageTocCloseIcon'	=>	BMC\blogmatic_get_customizer_option( 'page_toc_close_icon' ),
		/* Header Sticky */
		'headerStickyScrollUp'	=>	BMC\blogmatic_get_customizer_option( 'header_sticky_on_scroll_up' ),
		'headerStickyScrollDown'	=>	BMC\blogmatic_get_customizer_option( 'header_sticky_on_scroll_down' ),

		'isSingle'	=>	is_single(),
		'isPage'	=>	is_page(),
	]);

	wp_localize_script( 'blogmatic-navigation', 'blogmaticNavigationObject', [
		'menuCutoffOption'	=>	BMC\blogmatic_get_customizer_option( 'menu_cutoff_option' ),
		'menuCutoffAfter'	=>	BMC\blogmatic_get_customizer_option( 'menu_cutoff_after' ),
		'menuCutoffText'	=>	BMC\blogmatic_get_customizer_option( 'menu_cutoff_text' )
	]);
...
add_action( 'wp_enqueue_scripts', 'blogmatic_scripts' );


/**
 * Enqueue styles and scripts for admin dashboard
 */
function blogmatic_admin_scripts() {
	wp_enqueue_script( 'blogmatic-metabox', get_template_directory_uri() . '/inc/metabox/metabox.js', ['jquery'], BLOGMATIC_VERSION, true );
}
add_action( 'admin_enqueue_scripts', 'blogmatic_admin_scripts' );
...
new Blogmatic_Admin\Admin_Page();
...
if( !function_exists( 'blogmatic_typo_fonts_url' ) ) :
	/**
	 ...
	 * @since 1.0.0
	 */
	function blogmatic_typo_fonts_url() {
		$filter = BLOGMATIC_PREFIX . 'typo_combine_filter';
		$action = function( $filter, $id, $value = '' ) {
		...
		// typography preset
		$typography_presets_array = BMC\blogmatic_get_customizer_option( 'typography_presets' );
		if( array_key_exists( 'typographies', $typography_presets_array ) ) :
			...
			foreach( $typographies as $typography ) :
				$typography_presets[] = $action( $filter, 'typography_presets', $typography );
			endforeach;
		endif;
		...
		$breadcrumb_typo = $action($filter, 'breadcrumb_typo');
		// typography section
		...
		$sidebar_pagination_button_typo_value = $action($filter, 'sidebar_pagination_button_typo');
		...
		// custom button
		$custom_button_text_typography_value = $action($filter, 'custom_button_text_typography');
		// main banner
		...
		// video playlist
		$video_playlist_active_title_typo = $action($filter, 'video_playlist_active_title_typo');
		$video_playlist_title_typo = $action($filter, 'video_playlist_title_typo');
		$video_playlist_video_time_typo = $action($filter, 'video_playlist_video_time_typo');
		// category collection
		$category_collection_typo = $action($filter, 'category_collection_typo');
		...
		$archive_comment_typo = $action($filter, 'archive_comment_typo');
		...
		// error page
		$error_page_title_typo = $action($filter, 'error_page_title_typo');
		$error_page_content_typo = $action($filter, 'error_page_content_typo');
		$error_page_button_text_typo = $action($filter, 'error_page_button_text_typo');
		// footer
		$footer_title_typography = $action($filter, 'footer_title_typography');
		$footer_text_typography = $action($filter, 'footer_text_typography');
		// bottom footer
		$bottom_footer_text_typography = $action($filter, 'bottom_footer_text_typography');
		$bottom_footer_link_typography = $action($filter, 'bottom_footer_link_typography');
		// instagram section
		$instagram_button_typo = $action($filter, 'instagram_button_typo');
		$footer_instagram_button_typo = $action($filter, 'footer_instagram_button_typo');
		$global_button_typo = $action($filter, 'global_button_typo');
		// you may have missed
		$you_may_have_missed_design_section_title_typography = $action($filter, 'you_may_have_missed_design_section_title_typography');
		$you_may_have_missed_design_post_title_typography = $action($filter, 'you_may_have_missed_design_post_title_typography');
		$you_may_have_missed_design_post_categories_typography = $action($filter, 'you_may_have_missed_design_post_categories_typography');
		$you_may_have_missed_design_post_date_typography = $action($filter, 'you_may_have_missed_design_post_date_typography');
		$you_may_have_missed_design_post_author_typography = $action($filter, 'you_may_have_missed_design_post_author_typography');

		$typo1 = $action($filter, 'default_typo_one');
		
		$get_fonts = [ $typo1, $site_title_typo_value, $breadcrumb_typo, $site_description_typo_value, $heading_one_typo_value, $heading_two_typo_value, $heading_three_typo_value, $heading_four_typo_value, $heading_five_typo_value, $heading_six_typo_value, $sidebar_block_title_typography_value, $sidebar_post_title_typography_value, $sidebar_category_typography_value, $sidebar_date_typography_value, $sidebar_pagination_button_typo_value, $sidebar_heading_one_typography_value, $sidebar_heading_two_typo_value, $sidebar_heading_three_typo_value, $sidebar_heading_four_typo_value, $sidebar_heading_five_typo_value, $sidebar_heading_six_typo_value, $main_menu_typo_value, $main_menu_sub_menu_typo_value, $custom_button_text_typography_value, $main_banner_design_post_title_typography_value, $main_banner_design_post_excerpt_typography_value, $main_banner_design_post_categories_typography_value, $main_banner_design_post_date_typography_value, $main_banner_design_post_author_typography_value, $carousel_design_post_title_typography_value, $carousel_design_post_excerpt_typography_value, $carousel_design_post_categories_typography_value, $carousel_design_post_date_typography_value, $carousel_design_post_author_typography_value, $video_playlist_active_title_typo, $video_playlist_title_typo, $video_playlist_video_time_typo, $category_collection_typo, $archive_title_typo_value, $archive_excerpt_typo_value, $archive_category_typo_value, $archive_date_typo_value, $archive_author_typo_value, $archive_read_time_typo_value, $archive_comment_typo, $archive_category_info_box_title_typo_value, $archive_category_info_box_description_typo_value, $archive_tag_info_box_title_typo_value, $archive_tag_info_box_description_typo_value, $archive_author_info_box_title_typo_value, $archive_author_info_box_description_typo_value, $single_title_typo_value, $single_content_typo_value, $single_category_typo_value, $single_date_typo_value, $single_author_typo_value, $single_read_time_typo_value, $page_title_typo_value, $page_content_typo_value, $error_page_title_typo, $error_page_content_typo, $error_page_button_text_typo, $footer_title_typography, $footer_text_typography, $bottom_footer_text_typography, $bottom_footer_link_typography, $instagram_button_typo, $footer_instagram_button_typo, $global_button_typo, $you_may_have_missed_design_section_title_typography, $you_may_have_missed_design_post_title_typography, $you_may_have_missed_design_post_categories_typography, $you_may_have_missed_design_post_date_typography, $you_may_have_missed_design_post_author_typography ];
		$get_filtered_fonts = apply_filters( 'blogmatic_get_fonts_toparse', array_merge( $get_fonts, $typography_presets ) );
		$_new_fonts_array = [];
...
if( ! function_exists( 'blogmatic_parse_icon_picker_value' ) ) :
	/**
	 * Function to return image url for icon picker
	 */
	function blogmatic_parse_icon_picker_value ( $control ) {
		if( $control['type'] == 'svg' ) :
...
if( ! function_exists( 'blogmatic_get_all_social_share' ) ) :
	/**
	 * All social share icons and urls
	 * 
	 * @since 1.0.0
	 */
	function blogmatic_get_all_social_share() {
		$postUrl = 'http' . ( isset( $_SERVER['HTTPS'] ) ? 's' : '' ) . '://' . "{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
        return [
			'fa-brands fa-facebook'	=>	[
				'label'	=>	esc_html__( 'Facebook', 'blogmatic-pro' ),
			...
			'fa-brands fa-square-x-twitter'	=>	[
				'label'	=>	esc_html__( 'Twitter', 'blogmatic-pro' ),
			...
			'fa-brands fa-linkedin'	=>	[
				'label'	=>	esc_html__( 'Linkedin', 'blogmatic-pro' ),
			...
			'fa-solid fa-envelope'	=>	[
				'label'	=>	esc_html__( 'Envelope', 'blogmatic-pro' ),
			...
			'fa-brands fa-whatsapp'	=>	[
				'label'	=>	esc_html__( 'Whatsapp', 'blogmatic-pro' ),
			...
			'fa-brands fa-reddit'	=>	[
				'label'	=>	esc_html__( 'Reddit', 'blogmatic-pro' ),
			...
			'fa-brands fa-weixin'	=>	[
				'label'	=>	esc_html__( 'Weixin', 'blogmatic-pro' ),
				'value'	=>	'https://widget.wechat.com/o/qrcode/',
			],
			'fa-brands fa-tumblr'	=>	[
				'label'	=>	esc_html__( 'Tumblr', 'blogmatic-pro' ),
			...
			'fa-brands fa-weibo'	=>	[
				'label'	=>	esc_html__( 'Weibo', 'blogmatic-pro' ),
				'value'	=>	'http://service.weibo.com/share/share.php?url=',
			],
			'fa-brands fa-google-plus'	=>	[
				'label'	=>	esc_html__( 'Google Plus', 'blogmatic-pro' ),
			...
			'fa-brands fa-skype'	=>	[
				'label'	=>	esc_html__( 'Skype', 'blogmatic-pro' ),
				'value'	=>	'https://web.skype.com/share?url=',
			],
			'fa-brands fa-telegram'	=>	[
				'label'	=>	esc_html__( 'Telegram', 'blogmatic-pro' ),
				'value'	=>	'https://telegram.me/share/url?url=',
			],
			'fa-brands fa-pinterest'	=>	[
				'label'	=>	esc_html__( 'Pinterest', 'blogmatic-pro' ),
			...
			'fa-brands fa-vk'	=>	[
				'label'	=>	esc_html__( 'VK', 'blogmatic-pro' ),
				'value'	=>	'http://vk.com/share.php?url=',
			],
			'fa-brands fa-line'	=>	[
				'label'	=>	esc_html__( 'Line', 'blogmatic-pro' ),
				'value'	=>	'https://social-plugins.line.me/lineit/share?url=',
			],
			'fa-brands fa-blogger'	=>	[
				'label'	=>	esc_html__( 'Blogger', 'blogmatic-pro' ),
			...
			'fa-brands fa-digg'	=>	[
				'label'	=>	esc_html__( 'Digg', 'blogmatic-pro' ),
				'value'	=>	'http://digg.com/submit?url=',
			],
			'fa-brands fa-stumbleupon-circle'	=>	[
				'label'	=>	esc_html__( 'Stumbleupon', 'blogmatic-pro' ),
			...
			'fa-solid fa-copy'	=>	[
				'label'	=>	esc_html__( 'Copy', 'blogmatic-pro' ),
				'value'	=>	$postUrl,
			],
			'fa-solid fa-print'	=>	[
				'label'	=>	esc_html__( 'Print', 'blogmatic-pro' ),
				'value'	=>	'print',
			],
			'fa-brands fa-amazon'	=>	[
				'label'	=>	esc_html__( 'Amazon', 'blogmatic-pro' ),
				'value'	=>	'http://www.amazon.com/wishlist/add?u=',
			],
			'fa-brands fa-renren'	=>	[
				'label'	=>	esc_html__( 'Renren', 'blogmatic-pro' ),
				'value'	=>	'https://www.connect.renren.com/share/sharer?url=',
			],
			'fa-brands fa-trello'	=>	[
				'label'	=>	esc_html__( 'Trello', 'blogmatic-pro' ),
				'value'	=>	'https://trello.com/add-card?mode=popup&url=',
			],
			'fa-brands fa-viadeo'	=>	[
				'label'	=>	esc_html__( 'Viadeo', 'blogmatic-pro' ),
...
if( ! function_exists( 'blogmatic_get_all_fontawesome_icons' ) ) :
	/**
	 ...
	 * 
	 */
	function blogmatic_get_all_fontawesome_icons( $type = '' ) {
        $fontawesome_icons = [
...
add_action( 'after_setup_theme', function(){
	$theme_activation_date = get_option( 'blogmatic_theme_activation_date_timestamp' );
	if( ! $theme_activation_date ) update_option( 'blogmatic_theme_activation_date_timestamp', current_time( 'timestamp' ) );
});
